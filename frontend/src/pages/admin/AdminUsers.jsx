        ...
        <AdminLayout>
            <div className="grid lg:grid-cols-[400px_1fr] gap-10 lg:gap-16 items-start">
                ...
                <div>
                    ...
                    <form onSubmit={handleSubmit} className="ticket-border p-6 grid gap-4">
                ...
                <button
                    ...
                    className="bg-[#4A6B53] text-white px-6 py-3 text-[14px] font-medium tracking-wide hover:bg-[#3A5641] transition-colors disabled:opacity-60 rounded-sm w-full md:w-auto mt-2 shadow-sm"
                >
                    {status.state === 'loading' ? 'Creating...' : 'Create staff account'}
                </button>
                {status.message && (
                    <div className={`mt-2 p-4 text-[14px] font-medium rounded-sm border flex items-start gap-3 ${
                        status.state === 'error' 
                ...
                {/* Right Side: List */}
                <div>
                    <h2 className="font-display italic text-3xl mb-6">Current staff</h2>
